...
namespace {
    ...
    class auto_array {
        ...
        public:
            ...
            ~auto_array() { if (!isReleased && array != NULL) delete[] array; }
...
Image* loadBMP(const char* filename) {
    ...
    switch(headerSize) {
        case 40:
            ...
            input.ignore(2);
            assert(readShort(input) == 24 || !"Bukan 24 bits!");
            assert(readShort(input) == 0 || !"Dikompres!");
            break;
        case 12:
            ...
            assert(readShort(input) == 24 || !"Bukan 24 bits!");
            break;
        default: assert(!"Format tidak didukung!");
    }
